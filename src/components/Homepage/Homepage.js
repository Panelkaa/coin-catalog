    ...
    render() {
        return (
            <div>
                {!this.state.active ?
                    <>
                        <Search updateActive={this.btn} coins={this.state.searchCoins} titleHome="Homepage" />
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card-body">
                                        ...
                                        <div> <h3 className="card__text" title="Canadian Beaver"><b>Bullion coins</b></h3> </div>
                        ...
                        </div> </> : <><Search updateActive={this.btn} coins={this.state.searchCoins} titleHome="Homepage" /> </>}
